...
public class AxisSmokeStackBlock extends SmokeStackBlock {
    ...
    public AxisSmokeStackBlock(Properties properties, RotationType rotationType, SmokeEmissionParams emissionParams, ShapeWrapper shape, boolean createsStationarySmoke) {
